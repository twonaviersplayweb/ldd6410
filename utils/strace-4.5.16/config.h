...
/* Define to 1 if `dqb_curblocks' is member of `struct dqblk'. */
...
/* Define to 1 if `sc_hi2' is member of `struct sigcontext'. */
...
#define PACKAGE_STRING "strace 4.5.16"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "strace"

/* Define to the version of this package. */
#define PACKAGE_VERSION "4.5.16"
